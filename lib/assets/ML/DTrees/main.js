  ...
  const DTreesFormCustom = {
    ...
    <div class="row mixed-row">
      <BaseInput
        name="max_depth"
        label="Max Depth"
        labelTooltop="The maximum possible depth of the tree. That is the training algorithms attempts to split a node while its depth is less than maxDepth. The root node has zero depth."
        type="number"
