...
const SVMSmartCellConfig = (ctx, info) => {
    const extra_components = {
        SVMWithTrainDataVar: SVMModel("", {enable_input: true, input_use_traindata_var: true, enable_output: true}),
        SVMWithTrainData: SVMModel("", {enable_input: true, input_use_traindata_var: false, enable_output: true}),
    };
    const extra_data = {
        data_from: [
            { label: "TrainData Variable", value: "traindata_var" },
